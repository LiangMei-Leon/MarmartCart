...
namespace LightSide
{
    ...
    public sealed class TextLayout
    {
            ...
            out float height)
        {
            ...
            var hasBoundedWidth = !TextProcessSettings.IsUnbounded(availableWidth);
            ...
            for (var i = 0; i < lineCount; i++)
            {
                ...
                var justifyThisLine = hasBoundedWidth
                ...
                if (line.startMargin > 0 && hasBoundedWidth && !justifyThisLine)
                {
                    if (isRtlLine)
                    {
        ...
        private float ComputeTextStartY(float totalTextHeight, LayoutSettings settings)
        {
            ...
            if (TextProcessSettings.IsUnbounded(availableHeight)) return 0;
