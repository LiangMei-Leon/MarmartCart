...
namespace LightSide
{
    ...
    public sealed partial class ByModifier : IMarkupSelector, IModifierChangeSink
    {
        ...
        [Tooltip("Modifier type whose markup is targeted; a Composite matches by its ordered child types.")]
    ...
    public sealed partial class ByRule : IMarkupSelector
    {
        ...
        [Tooltip("Identity of the parse rule whose markup is targeted, such as tag:b or marker:**. Case-insensitive.")]
