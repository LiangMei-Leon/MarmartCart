...
namespace LightSide
{
    ...
    public sealed partial class ChromeRule : IModifierChangeSink
    {
        ...
        [Tooltip("Which visible markup tags the rule styles: any markup, markup of a given modifier or of a given rule.")]
        ...
        [Tooltip("Modifier applied to matching visible tag characters.")]
        ...
        [Tooltip("Parameter passed to the style modifier, written like a tag value.")]
