...
namespace LightSide
{
    /// <summary>Receives the weight of a transient modifier application, saturated to 0..1.</summary>
    public interface IModifierRuleWeightReceiver
    {
        /// <summary>Sets the weight, 0..1, used by subsequent range applications in the current pass.</summary>
    ...
    public sealed partial class TransitionPlayback : RangeStatePlayback
    {
        ...
        [Tooltip("Seconds the transition takes when the selector starts matching.")]
        ...
        [Tooltip("Seconds the transition takes when the selector stops matching.")]
        ...
        [Tooltip("Easing curve applied to the enter and exit transitions.")]
        ...
        [Tooltip("Time source driving the transition: scaled game time, unscaled time or manual ticks.")]
        ...
        [Tooltip("Whether a range already matching when the rule starts animates in instead of snapping.")]
    ...
    public sealed partial class SignalProgressPlayback : RangeStatePlayback
    {
        ...
        [Tooltip("Progress signal driving the rule weight: long press, loading, drag or voice.")]
        ...
        [Tooltip("Signal value that maps to Output Min.")]
        ...
        [Tooltip("Signal value that maps to Output Max.")]
        ...
        [Tooltip("Rule weight when the signal is at or below Input Min.")]
        ...
        [Tooltip("Rule weight when the signal is at or above Input Max.")]
        ...
        [Tooltip("Whether the weight starts from the current signal value instead of Enter Weight.")]
        ...
        [Tooltip("Starting weight used when Sample On Enter is off.")]
        ...
        [Tooltip("Seconds the weight fades to zero when the selector stops matching.")]
        ...
        [Tooltip("Easing curve of the exit fade.")]
        ...
        [Tooltip("Time source of the exit fade: scaled game time, unscaled time or manual ticks.")]
    ...
    public abstract partial class RuleValue : RangeConfigurationObject
    {
        ...
        [Tooltip("Whether the value is authored here or read from each range's payload.")]
        ...
        [Tooltip("Dot-separated payload member path read when Source is Payload Member.")]
        ...
        where TValue : unmanaged
    {
        ...
        [Tooltip("Authored value used when Source is Authored.")]
    ...
    public sealed partial class IntRuleValue : RuleValue<int> { }

    /// <summary>Bool ParameterRule target.</summary>
    [Serializable, TypeDescription("Bool value")]
    public sealed partial class BoolRuleValue : RuleValue<bool> { }
    ...
    public sealed partial class EnumRuleValue<TEnum> : RuleValue<TEnum>
    ...
    public abstract partial class RangeStateRule : RangeConfigurationObject
    {
        ...
        [Tooltip("Signal condition that keeps the rule active while it matches. Empty relies on the Trigger event alone.")]
        ...
        [Tooltip("How the rule enters, exits and reacts to its event: instant, transition, signal progress or manual.")]
        ...
        [Tooltip("Whether each segment of a range matches and plays back on its own or the whole range plays back as one.")]
        ...
        [Tooltip("One-shot event that also fires the rule: activation or context request. None uses the selector alone.")]
        ...
        [Tooltip("Priority among rules driving the same parameter; with Replace composition the highest wins.")]
    ...
    public sealed partial class ParameterRule : RangeStateRule
    {
        ...
        [Tooltip("Value applied to the parameter: the target for Replace, or the contribution for Add and Multiply.")]
        ...
        [Tooltip("How the value combines with the parameter's baseline and other active rules: replace, add, multiply or custom.")]
    ...
    public sealed partial class ModifierRule : RangeStateRule
    {
        ...
        [Tooltip("Modifier applied to matching ranges only while the rule is active.")]
        ...
        [Tooltip("Rebuild the text needs when the modifier appears or disappears. Mesh is cheapest and covers paint-only changes.")]
