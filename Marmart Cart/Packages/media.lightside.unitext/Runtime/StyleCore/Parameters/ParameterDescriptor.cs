...
namespace LightSide
{
        ...
        where TModifier : BaseModifier
    {
        ...
        /// <summary>
        /// Interpolates between two values under this parameter's type contract, extrapolating past either
        /// endpoint where the type allows.
        /// </summary>
        public TValue Lerp(TValue from, TValue to, float t) => ops.Lerp(from, to, t);
    ...
    public interface IParameterOps<TValue>
    {
        ...
        /// progress, with zero selecting the former and one selecting the latter. Progress outside
        /// [0, 1] extrapolates; a type that cannot extrapolate selects the endpoint the progress lies
        /// beyond, and one with a bounded range saturates.
        /// </summary>
