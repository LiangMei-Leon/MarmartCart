...
namespace LightSide
{
    ...
    public partial class InlineObject : InlineMedia
    {
        ...
        [Tooltip("UI prefab instantiated in the text flow for this entry.")]
    ...
    [Serializable]
    public sealed partial class InlineObjectOverride : InlineMediaOverride
    {
    }
