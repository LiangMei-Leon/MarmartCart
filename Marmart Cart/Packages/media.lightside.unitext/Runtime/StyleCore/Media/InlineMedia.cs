...
namespace LightSide
{
    ...
    public abstract partial class InlineMedia
    {
        ...
        [Tooltip("Name the tag looks the entry up by; case-insensitive.")]
        [SerializeField, StateProperty]
        private string name;

        /// <summary>Size in em units (1 = fontSize on each axis).</summary>
        [Tooltip("Size in em; 1 equals the font size on each axis.")]
        [SerializeField, VectorDragField, StateProperty]
        private Vector2 size = Vector2.one;

        /// <summary>Offset from the layout position in em units.</summary>
        [Tooltip("Shift from the layout position, in em.")]
        [SerializeField, VectorDragField, StateProperty]
        private Vector2 bearingOffset;

        /// <summary>Normalized anchor in the size box: content that does not fill the box is held to it, and rotation turns about it. (0,0) is bottom-left, (1,1) top-right.</summary>
        [Tooltip("Anchor in the size box, normalized: holds content that does not fill the box and centres the rotation; (0,0) is bottom-left, (1,1) is top-right.")]
        [SerializeField, VectorDragField, StateProperty]
        private Vector2 pivot;

        /// <summary>Z-axis rotation in degrees around <see cref="Pivot"/>.</summary>
        [Tooltip("Rotation around the pivot, in degrees.")]
        [SerializeField, StateProperty]
        private float rotation;

        /// <summary>Advance width in em units (1 = fontSize).</summary>
        [Tooltip("How far the text cursor moves past the media, in em; 1 equals the font size.")]
        [SerializeField, StateProperty]
        private float advance = 1;

        /// <summary>Extra height reserved above lines containing this media, in em units.</summary>
        [Tooltip("Extra height reserved above any line containing this media, in em.")]
        ...
        [Tooltip("Extra height reserved below any line containing this media, in em.")]
        [SerializeField, StateProperty]
    ...
    public abstract partial class InlineMediaOverride
    {
        ...
        [Tooltip("Name of the provider entry this row overrides; the same name is used in tags.")]
        [SerializeField, StateProperty]
        private string key;

        /// <summary>Size override in em; NaN per axis inherits the provider entry.</summary>
        [Tooltip("Size in em; NaN per axis inherits the provider entry.")]
        ...
        [Tooltip("Shift from the layout position, in em; NaN per axis inherits the provider entry.")]
        ...
        [Tooltip("How far the text cursor moves past the media, in em; NaN inherits the provider entry.")]
        ...
        [Tooltip("Extra line space above, in em; NaN inherits the provider entry.")]
        ...
        [Tooltip("Extra line space below, in em; NaN inherits the provider entry.")]
        [SerializeField, Parameter, Inheritable(0f), StateProperty]
        private float lineHeightBelow = float.NaN;

        /// <summary>Normalized anchor override; NaN per axis inherits the provider entry.</summary>
        [Tooltip("Anchor in the size box, normalized; NaN per axis inherits the provider entry.")]
        ...
        [Tooltip("Rotation around the pivot, in degrees; NaN inherits the provider entry.")]
        [SerializeField, Parameter, Inheritable(0f), StateProperty]
