...
namespace LightSide
{
    ...
    {
        [Tooltip("Whether the layer uses its own default, an inline colour, or a named swatch from its paint provider.")]
        public PaintRefKind kind;
        [Tooltip("Solid colour used when Kind is Color.")]
        public Color32 color;
        [Tooltip("Name of the paint swatch used when Kind is Swatch; it may be solid, gradient, or texture.")]
