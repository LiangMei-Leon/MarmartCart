...
namespace LightSide
{
    ...
    public sealed partial class StrokeModifier : PaintLayerModifier
    {
        ...
        [Tooltip("Colour or named swatch of the outline; Default is black.")]
        ...
        [Tooltip("Thickness of the outline band.")]
        ...
        [Tooltip("Softness of the outline edges; 0 keeps them crisp.")]
        [SerializeField, Parameter, Unit("px|em"), StateProperty(nameof(MarkMeshDirty))]
