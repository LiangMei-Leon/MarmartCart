...
namespace LightSide
{
    ...
    public sealed partial class InnerShadowModifier : PaintLayerModifier
    {
        ...
        [Tooltip("Colour or named swatch of the inner shadow; Default is black.")]
        ...
        [Tooltip("Displacement of the inner shadow inside the glyph, horizontally and vertically.")]
        ...
        [Tooltip("Blur radius of the inner shadow; 0 keeps its edge crisp.")]
        [SerializeField, Parameter, Unit("px|em"), StateProperty(nameof(MarkMeshDirty))]
