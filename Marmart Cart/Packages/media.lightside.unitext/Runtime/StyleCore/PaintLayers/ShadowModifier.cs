...
namespace LightSide
{
    ...
    public sealed partial class ShadowModifier : PaintLayerModifier
    {
        ...
        [Tooltip("Colour or named swatch of the shadow; Default is half-transparent black.")]
        ...
        [Tooltip("Displacement of the shadow from the glyph, horizontally and vertically.")]
        ...
        [Tooltip("Blur radius of the shadow; 0 keeps its edge crisp.")]
        [SerializeField, Parameter, Unit("px|em"), StateProperty(nameof(MarkMeshDirty))]
        private UnitValue blur = UnitValue.Em(0.1f);

        /// <summary>Shadow spread. A per-range value overrides it.</summary>
        [Tooltip("Outward growth of the shadow beyond the glyph outline.")]
        [SerializeField, Parameter, Unit("px|em"), StateProperty(nameof(MarkMeshDirty))]
