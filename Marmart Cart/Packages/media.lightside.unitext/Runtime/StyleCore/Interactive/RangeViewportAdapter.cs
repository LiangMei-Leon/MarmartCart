...
namespace LightSide
{
    ...
    {
        [Tooltip("UniText component whose ranges are revealed. Empty uses the UniText on this GameObject.")]
    ...
    {
        [Tooltip("Scroll Rect whose content is shifted just enough to bring the requested range into view.")]
    ...
    public sealed partial class CameraRangeViewport : RangeViewportAdapter
    {
        ...
        [Tooltip("Camera whose viewport must contain the requested range.")]
        ...
        [Tooltip("Transform panned to reveal the range. Empty moves the camera itself.")]
        ...
        [Tooltip("Screen-space inset in pixels kept between the revealed range and the viewport edges.")]
