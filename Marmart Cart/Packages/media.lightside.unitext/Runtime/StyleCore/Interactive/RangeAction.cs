...
namespace LightSide
{
    ...
    public sealed partial class RangeActionString : RangeConfigurationObject
    {
        ...
        [Tooltip("Where the text comes from: the range's primary value, a literal, a payload member or the covered text.")]
        ...
        [Tooltip("Text used when Source is Literal.")]
    ...
    public abstract partial class RangeAction : RangeConfigurationObject
    {
        ...
        [Tooltip("Events that run the action: activation (click, tap), context request (right click, long press) or both.")]
    ...
    {
        [Tooltip("URL to open, resolved from the primary value, a literal, the covered text or a payload member.")]
    ...
    {
        [Tooltip("Text to copy, resolved from the covered text, the primary value, a literal or a payload member.")]
    ...
    public sealed partial class SetActiveAction : RangeAction
    {
        ...
        [Tooltip("Object whose active state is changed.")]
        ...
        [Tooltip("Active state given to the target when the action runs.")]
