...
namespace LightSide
{
    ...
    public partial class PulseModifier : GlyphParamModifier<PulseModifier.Params>
    {
        ...
        [Tooltip("Peak scale deviation: 0.15 pulses between 85% and 115%.")]
        ...
        [Tooltip("Pulses per phase unit.")]
        [SerializeField, Parameter, StateProperty(nameof(MarkParamsDirty))]
        private float frequency = 3f;

        /// <summary>Phase offset between adjacent clusters.</summary>
        [Tooltip("Phase offset between neighbouring glyphs, in radians; 0 pulses every glyph in sync.")]
        [SerializeField, Parameter, StateProperty(nameof(MarkParamsDirty))]
