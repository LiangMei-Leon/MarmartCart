...
namespace LightSide
{
    ...
    public partial class WaveModifier : GlyphParamModifier<WaveModifier.Params>
    {
        ...
        [Tooltip("Peak vertical offset in pixels.")]
        ...
        [Tooltip("Oscillations per phase unit.")]
        ...
        [Tooltip("Phase offset between neighbouring glyphs, in radians, so the wave travels along the text; 0 moves every glyph in sync.")]
        [SerializeField, Parameter, StateProperty(nameof(MarkParamsDirty))]
