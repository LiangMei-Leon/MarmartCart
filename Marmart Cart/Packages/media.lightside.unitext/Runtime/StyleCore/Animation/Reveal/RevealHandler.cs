...
namespace LightSide
{
    ...
    public abstract partial class RevealHandler
    {
        ...
        [Tooltip("Seconds this effect takes to play for one glyph; 0 makes the change instant.")]
    ...
    public abstract partial class EasedRevealHandler : RevealHandler
    {
        ...
        [Tooltip("Progress curve the effect follows from its starting state to the settled glyph.")]
    ...
    public abstract partial class GeometricRevealHandler : EasedRevealHandler
    {
        ...
        /// beside the glyph.
        /// </summary>
        [Tooltip("Point the effect scales, rotates and shears around, as a fraction of the glyph box: 0,0 bottom-left, 1,1 top-right. Values outside land beside the glyph.")]
    ...
    public sealed partial class CompositeRevealHandler : RevealHandler
    {
        ...
        [Tooltip("Appearance effects applied in order to the same glyph. Each plays over its own duration; a shorter one settles early.")]
    ...
    public sealed partial class RevealHandlerEntry
    {
        ...
        [Tooltip("Name a reveal tag selects this entry by, case-insensitive; empty serves ranges that select no name.")]
        ...
        [Tooltip("Appearance effect applied to ranges that select this entry.")]
        ...
        /// </summary>
        [Tooltip("Effect played while a glyph of this entry leaves the visible part of its range. Unset plays the appearance effect backwards.")]
        [SerializeReference, TypeSelector,
         StateProperty(nameof(ApplyHandlerSwap), Owned = true), StateLink]
