...
namespace LightSide
{
    ...
    public partial class RollingModifier : BaseModifier
    {
        ...
        [Tooltip("Wheel steps still to travel; 0 shows the real text. Negative values roll the opposite direction.")]
        ...
        [Tooltip("Roll reduction per rolling character along the text; each has that much less to travel than the one before.")]
        ...
        [Tooltip("Wheel characters in rolling order; only these roll, the rest pass through untouched. Characters beyond the basic Unicode plane cannot roll.")]
