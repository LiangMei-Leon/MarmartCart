...
namespace LightSide
{
    ...
    public sealed partial class SeparatorParseRule : ParseRule
    {
        ...
        [Tooltip("Separator tag name without angle brackets.")]
        ...
        [Tooltip("Text inserted in place of the tag. A value written in the tag overrides it for that occurrence.")]
        [StateProperty(nameof(NotifyChanged))]
