...
namespace LightSide
{
    ...
    public sealed partial class RubyParseRule : ParseRule
    {
        ...
        [Tooltip("Tag name of the outer ruby element, without angle brackets.")]
        [StateProperty(nameof(NotifyChanged))]
        [SerializeField] private string rubyTag = "ruby";
        /// <summary>Ruby-text element name.</summary>
        [Tooltip("Tag name of the reading element inside the ruby, without angle brackets.")]
        [StateProperty(nameof(NotifyChanged))]
        [SerializeField] private string textTag = "rt";
        /// <summary>Fallback-parentheses element name.</summary>
        [Tooltip("Tag name of the fallback-parentheses element, without angle brackets; its content is stripped.")]
        [StateProperty(nameof(NotifyChanged))]
