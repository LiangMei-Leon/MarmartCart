...
namespace LightSide
{
    ...
    public partial class TagRule : TagParseRule
    {
        ...
        [Tooltip("Tag name matched without angle brackets.")]
        ...
        /// </summary>
        [Tooltip("Fallback values for slots the tag's value leaves empty; the tag wins. Empty keeps the modifier defaults.")]
        [StateProperty(nameof(NotifyChanged))]
