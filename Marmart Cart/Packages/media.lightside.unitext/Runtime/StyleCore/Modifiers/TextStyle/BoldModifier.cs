...
namespace LightSide
{
    ...
    public partial class BoldModifier : PooledAttributeModifier<ushort>
    {
        ...
        [Tooltip("Target weight on the 1 to 1000 scale. 0 picks it automatically: at least 700 and 300 above the font's own weight.")]
        ...
        [Tooltip("How bold is achieved: prefer a real bold face, synthesize it on the current face, or use a real face only.")]
