...
namespace LightSide
{
    ...
    public partial class VariationModifier : PooledAttributeModifier<byte>
    {
        ...
        [Tooltip("Weight axis (wght): absolute 1 to 1000, % of the font's default, or a +/- delta from it.")]
        ...
        [Tooltip("Width axis (wdth): absolute 50 to 200, % of the font's default, or a +/- delta from it.")]
        ...
        [Tooltip("Italic axis (ital): 0 upright to 1 italic, or a +/- delta from the font's default.")]
        ...
        [Tooltip("Slant axis (slnt) in degrees, -90 to 90, or a +/- delta from the font's default.")]
        ...
        [Tooltip("Optical size axis (opsz): absolute 1 to 144, % of the font's default, or a +/- delta from it.")]
