...
namespace LightSide
{
    ...
    public partial class RubyModifier : BaseModifier
    {
        ...
        /// </summary>
        [Tooltip("Annotation size as a fraction of the base text size, 0.1 to 1. 0.5 is the typographic norm.")]
        ...
        [Tooltip("How a narrower annotation is distributed over its base column.")]
        ...
        [Tooltip("Annotation side relative to the base: above (over) or below (under).")]
