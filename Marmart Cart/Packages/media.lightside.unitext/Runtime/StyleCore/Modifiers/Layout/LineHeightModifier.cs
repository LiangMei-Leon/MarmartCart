...
namespace LightSide
{
    ...
    public partial class LineHeightModifier : BaseModifier
    {
        ...
        [Tooltip("Optional adjustment on top of the mode: % or em multiplies, a bare number is pixels, +/- adds pixels. 0 means none.")]
        ...
        [Tooltip("Base line height: the tallest font on the line, the primary font only, or a fixed multiple of the font size.")]
        ...
        [Tooltip("Font-size multiplier for the line height in Scaled mode; ignored in the other modes.")]
        ...
        [Tooltip("Where extra line spacing goes: split above and below the text, all above, or all below.")]
