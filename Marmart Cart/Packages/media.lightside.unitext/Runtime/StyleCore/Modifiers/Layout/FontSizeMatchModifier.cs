...
namespace LightSide
{
    ...
    public sealed partial class FontSizeMatchModifier : BaseModifier
    {
        ...
        [Tooltip("Metric the fonts are matched on: x-height (body text) or cap-height (all-caps, symbols). None disables matching.")]
        ...
        [Tooltip("Aspect every font is scaled to, as metric divided by font size. 0 matches the primary font instead.")]
