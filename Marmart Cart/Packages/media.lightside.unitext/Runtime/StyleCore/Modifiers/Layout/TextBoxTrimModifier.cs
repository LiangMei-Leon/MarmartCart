...
namespace LightSide
{
    ...
    public sealed partial class TextBoxTrimModifier : BaseModifier
    {
        ...
        [Tooltip("Metric the top of the text box is trimmed to, such as the ascent line or cap height.")]
        ...
        [Tooltip("Metric the bottom of the text box is trimmed to, such as the descent line or baseline.")]
