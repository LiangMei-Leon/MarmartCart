...
namespace LightSide
{
    ...
    public partial class EllipsisModifier : BaseModifier
    {
        ...
        [Tooltip("Where the cut sits in the truncated line: 0 start, 0.5 middle, 1 end. No effect once word wrap clamps whole lines.")]
        ...
        private void OnLayoutComplete()
        {
            ...
            var hasHeightOverflow = !TextProcessSettings.IsUnbounded(maxHeight) && resultHeight > maxHeight + OverflowEpsilon;
            var hasWidthOverflow = !uniText.WordWrap && !TextProcessSettings.IsUnbounded(maxWidth) && resultWidth > maxWidth + OverflowEpsilon;
