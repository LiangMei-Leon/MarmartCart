...
namespace LightSide
{
    ...
    public partial class IndentModifier : PooledAttributeModifier<float>
    {
        ...
        [Tooltip("Left indent kept across every wrapped line of the range, in pixels, em or % of the box width. Nested indents add up.")]
        ...
        private float ResolveToShapingUnits(float value, UnitKind unit)
        {
            switch (unit)
            {
                ...
                case UnitKind.Percent:
                    ...
                    if (TextProcessSettings.IsUnbounded(maxWidth)) return 0f;
