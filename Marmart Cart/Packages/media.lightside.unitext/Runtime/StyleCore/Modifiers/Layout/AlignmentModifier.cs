...
namespace LightSide
{
    ...
    public sealed partial class AlignmentModifier : BaseModifier
    {
        ...
        [Tooltip("Horizontal alignment of the lines in the covered paragraphs; Start and End follow the writing direction.")]
        ...
        [Tooltip("Where justified lines spread extra space: word spaces, every character boundary, or none. Auto prefers word spaces.")]
        ...
        [Tooltip("Alignment of each paragraph's last line under justification; Auto aligns it to the start.")]
