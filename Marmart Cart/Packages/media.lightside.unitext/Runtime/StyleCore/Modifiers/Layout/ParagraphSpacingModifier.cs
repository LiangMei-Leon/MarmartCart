...
namespace LightSide
{
    ...
    public partial class ParagraphSpacingModifier : BaseModifier
    {
        ...
        [Tooltip("Gap below each covered paragraph, in pixels or as % / em of the font size. Negative pulls paragraphs together.")]
        ...
        [Tooltip("Gap above each covered paragraph, in pixels or as % / em of the font size. Negative pulls paragraphs together.")]
