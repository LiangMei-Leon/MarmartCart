...
namespace LightSide
{
    ...
    public partial class ListModifier : BaseModifier
    {
        ...
        [Tooltip("Nesting level of the items, starting at 0; deeper levels indent further and use that level's marker.")]
        ...
        [Tooltip("Number shown before ordered items. -1 shows a bullet instead.")]
        ...
        [Tooltip("Inside: the marker sits inline before its content. Outside: content aligns to one column and markers hang before it.")]
        ...
        [Tooltip("Bullet text per nesting level; deeper levels reuse the last entry. At least one is required.")]
        ...
        [Tooltip("Numbering style per nesting level (decimal, letters, Roman numerals); deeper levels reuse the last entry.")]
