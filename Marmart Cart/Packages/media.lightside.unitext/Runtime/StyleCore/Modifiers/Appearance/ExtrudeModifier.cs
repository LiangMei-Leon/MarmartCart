...
namespace LightSide
{
    ...
    public partial class ExtrudeModifier : EffectModifier, IModifierCommitChanges
    {
        ...
        [Tooltip("Displacement of each extrusion step, in em. With Fixed Pixel Size on it is read as pixels instead.")]
        ...
        [Tooltip("Colour of the slice nearest the face; deeper slices blend toward the far colour.")]
        ...
        [Tooltip("Colour of the deepest slice, farthest from the face.")]
        ...
        [Tooltip("Outward thickening of every slice. Fixed Pixel Size reads it in pixels.")]
        ...
        [Tooltip("Edge softness of every slice; 0 keeps the edge crisp. Fixed Pixel Size reads it in pixels.")]
        ...
        /// </summary>
        [Tooltip("Slices stacked behind the face. More give a smoother, longer extrusion but add geometry per glyph; minimum 1.")]
        ...
        /// </summary>
        [Tooltip("Alternates the near and far colours per step instead of blending, for a faceted bevel. Doubles the slice count.")]
        ...
        /// of font size.
        /// </summary>
        [Tooltip("Reads offset, dilate and softness as fixed pixels, so the extrusion keeps its on-screen size at any font size.")]
