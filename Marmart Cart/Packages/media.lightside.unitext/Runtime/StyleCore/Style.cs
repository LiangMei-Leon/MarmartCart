...
namespace LightSide
{
    ...
    public sealed partial class Style : IModifierChangeSink, IRangeSourceChangeSink
    {
        ...
        [Tooltip("Modifier applied to every range the source produces.")]
        ...
        [Tooltip("Produces the ranges to style, such as a markup tag rule. Empty applies the modifier to the whole text.")]
        ...
        /// </summary>
        [Tooltip("Parameter handed to the modifier for the whole-text range when no source is set.")]
        ...
        [Tooltip("Skips this style entirely, as if removed, while keeping its configuration.")]
