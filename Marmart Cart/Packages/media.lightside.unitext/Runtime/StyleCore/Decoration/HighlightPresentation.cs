...
namespace LightSide
{
    ...
    public sealed partial class HighlightPresentation : IHasPaintProvider
    {
        ...
        [Tooltip("Colour or named swatch the highlight is painted with; Default is a translucent blue.")]
        ...
        [Tooltip("How the range splits into figures: per glyph, per line, per line rounded only at the range ends, or one connected block.")]
        ...
        [Tooltip("Where a gradient or texture restarts: per glyph, per line, per range, or once over the whole text; Inherit Geometry follows the figures.")]
        [SerializeField, Parameter, StateProperty]
        ...
        [Tooltip("Vertical extent of the figures: ascender to descender, the glyph ink only, or the full line pitch so lines meet without gaps.")]
        [SerializeField, Parameter, StateProperty]
        ...
        [Tooltip("Extra space added around each figure, horizontally and vertically.")]
        ...
        [Tooltip("Rounding of the figure corners; 0 keeps them square.")]
        [SerializeField, Parameter, Unit("px|em"), StateProperty]
        ...
        [Tooltip("Adjacent lines whose edges differ by less than this snap to one shared edge. A negative value uses the corner radius.")]
        [SerializeField, Parameter, Unit("px|em"), StateProperty]
        private UnitValue mergeThreshold = UnitValue.Em(0f);

        /// <summary>Whether the surface renders behind or above the text.</summary>
        [Tooltip("Whether the highlight draws behind or in front of the text.")]
        [SerializeField, Parameter, StateProperty]
        ...
        [Tooltip("How the highlight blends with what is beneath it; Inherit uses the paint's own mode.")]
        [SerializeField, Parameter, Inheritable, StateProperty]
        ...
        /// </summary>
        [Tooltip("How a gradient continues outside its frame: clamp, repeat, or mirror. Inherit uses the swatch's value.")]
        [SerializeField, Parameter, Inheritable, StateProperty]
