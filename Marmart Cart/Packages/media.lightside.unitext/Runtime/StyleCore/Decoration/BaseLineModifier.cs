...
namespace LightSide
{
        ...
        IModifierCommitChanges
    {
        ...
        [Tooltip("Colour or named swatch of the line; Default inherits the text fill.")]
        ...
        [Tooltip("Line style: solid, double, dotted, dashed, or wavy.")]
        ...
        [Tooltip("Line thickness; 0 takes the thickness from the font.")]
        ...
        [Tooltip("Vertical shift of the line from the position the font defines.")]
        ...
        [Tooltip("Breaks the line where descenders or ascenders cross it.")]
        ...
        [Tooltip("How the line blends with what is beneath it; Inherit follows its paint, or the text fill when the paint is Default.")]
        ...
        private void EmitLine(UniTextMeshGenerator gen)
        {
            ...
            if (!gen.FaceTakenOver) gen.AddSdfQuad(sequence, gen.faceBaseIdx, outputBlend);
        }
