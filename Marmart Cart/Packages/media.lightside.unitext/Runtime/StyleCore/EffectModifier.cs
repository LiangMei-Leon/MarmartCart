...
namespace LightSide
{
    ...
    public abstract partial class EffectModifier : BaseModifier, ILayer
    {
        ...
        [UnityEngine.Tooltip("How the effect composites with the layers rendered beneath it.")]
        ...
        /// </summary>
        [UnityEngine.Tooltip("How a projected gradient continues past its frame: clamp, repeat or mirror. Inherit uses the swatch's value.")]
        [UnityEngine.SerializeField, Parameter, Inheritable, StateProperty(nameof(MarkMeshDirty))]
        ...
        /// </summary>
        [UnityEngine.Tooltip("Whether colour glyphs such as emoji are decorated too, along their silhouette. Inherit uses the effect's own default.")]
        [UnityEngine.SerializeField, Parameter, Inheritable, StateProperty(nameof(MarkMeshDirty))]
