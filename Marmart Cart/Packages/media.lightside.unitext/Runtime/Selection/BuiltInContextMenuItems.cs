...
namespace LightSide
{
    ...
    [Serializable]
    public sealed partial class CopyContextMenuItem : CommandContextMenuItem
    {
    ...
    [Serializable]
    public sealed partial class CutContextMenuItem : CommandContextMenuItem
    {
    ...
    [Serializable]
    public sealed partial class PasteContextMenuItem : CommandContextMenuItem
    {
    ...
    [Serializable]
    public sealed partial class SelectAllContextMenuItem : CommandContextMenuItem
    {
    ...
    /// </summary>
    [Serializable]
    public sealed partial class ActionContextMenuItem : ButtonContextMenuItem
    {
