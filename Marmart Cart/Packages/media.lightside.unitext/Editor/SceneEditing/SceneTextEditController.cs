...
namespace LightSide.SceneEditing
{
    ...
    /// starts a session on an Alt+double-click over a <see cref="UniTextBase"/>, and feeds SceneView pointer
    ...
    internal static class SceneTextEditController
    {
        ...
        {
            if (e.type != EventType.MouseDown || e.button != 0 || !e.alt || e.clickCount < 2) return;
