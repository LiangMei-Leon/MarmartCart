...
namespace LightSide
{
    ...
    internal class ComponentMigrator
    {
        ...
        public bool Initialize()
        {
            ...
            {
                if (type.Namespace != "TMPro") continue;
                switch (type.Name)
                {
                    case "TextMeshProUGUI": tmpTextUiType = type; break;
                    case "TextMeshPro": tmpText3DType = type; break;
                    case "TMP_InputField": tmpInputFieldType = type; break;
                    case "TMP_SubMeshUI": tmpSubMeshUiType = type; break;
                    case "TMP_SubMesh": tmpSubMeshType = type; break;
                    case "TMP_SpriteAsset": tmpSpriteAssetType = type; break;
                    case "TMP_Settings": tmpSettingsType = type; break;
                }
            }
