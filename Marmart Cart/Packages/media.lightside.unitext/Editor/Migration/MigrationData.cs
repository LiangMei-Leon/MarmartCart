...
namespace LightSide
{
    ...
    internal class FontMappingEntry
    {
        ...
        /// <summary>Font file the UniText font is built from; empty when none is known.</summary>
        public string sourceTtfPath;
        /// <summary>True once the user pointed at the source file; the scan then leaves it alone.</summary>
        public bool sourceChosen;
    ...
    internal class ScannedFileRecord
    {
        ...
        /// <summary>GUID of the font file this font asset records as its source, when it records one.</summary>
