...
namespace LightSide
{
    ...
    internal static class ScriptMigrator
    {
        ...
        /// </summary>
        public static List<ScriptReplacement> AnalyzeFile(string filePath, ScriptMemberIndex projectIndex = null)
        {
            string content;
            ...
            return ScriptRewriter.Analyze(content, projectIndex);
        }
        ...
        public static (bool success, string backupPath, string error) ApplyReplacements(
            ...
            bool createBackup,
            ScriptMemberIndex projectIndex = null)
        {
            ...
            if (HasBlockers(ScriptRewriter.Analyze(content, projectIndex)))
                return (false, null, blockerError);
