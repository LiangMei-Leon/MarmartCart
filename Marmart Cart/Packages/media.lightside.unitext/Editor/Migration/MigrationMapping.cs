...
namespace LightSide
{
    ...
    internal static class MigrationMapping
    {
        ...
        /// <summary>
        /// The assembly holding TMP's types, in both the standalone TMP package and the uGUI
        /// package that absorbed it.
        /// </summary>
        public const string TmpAssemblyName = "Unity.TextMeshPro";
        ...
        /// <summary>YAML field holding the GUID of the font file a TMP font asset was built from.</summary>
        public const string SourceFontField = "m_SourceFontFileGUID";

        /// <summary>
        /// The same GUID inside the creation settings, the only place font assets written by
        /// older TMP versions keep it.
        /// </summary>
        public const string LegacySourceFontField = "sourceFontFileGUID";
        ...
        /// <summary>The text kind a UniText type name stands for, for source the rewrite already ran over.</summary>
        public static readonly Dictionary<string, TmpTypeKind> UniTextTypeKinds = BuildUniTextTypeKinds();

        private static Dictionary<string, TmpTypeKind> BuildUniTextTypeKinds()
        {
            var kinds = new Dictionary<string, TmpTypeKind>(StringComparer.Ordinal);
            foreach (var mapping in ScriptTypes.Values) kinds[mapping.UniTextName] = mapping.Kind;
            return kinds;
        }
