...
namespace LightSide
{
    ...
    internal static class ParameterFieldUtility
    {
        ...
        /// on the right; the field's <see cref="TooltipAttribute"/> reaches its hover tooltip and search.
        /// </summary>
        ...
        private sealed class ToolkitParameterField : VisualElement
        {
                ...
                Action<ToolkitValue, ToolkitValue> changed)
            {
                ...
                InspectorVisuals.SetTooltipTitle(this, field.name);
                AddToClassList(InspectorVisuals.TooltipOwnerClass);
