...
namespace LightSide
{
    ...
    {
        /// <summary>Applies the current envelope weight to the host's outputs; its range is that of <see cref="Playback.Weight"/>.</summary>
    ...
    public struct Playback
    {
        ...
        /// <summary>
        /// Current envelope weight: the blend between the host's baseline at 0 and its target at 1, which a
        /// transition in flight carries past either bound as its easing dictates.
        /// </summary>
        ...
        /// immediately. A releasing run releases the host's outputs on completing at or below zero weight.
        /// </summary>
