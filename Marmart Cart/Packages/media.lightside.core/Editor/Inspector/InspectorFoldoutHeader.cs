...
namespace LightSide
{
    ...
    public class InspectorFoldoutHeader : VisualElement
    {
        ...
        /// <summary>Sizing class for an icon button placed among a header's actions; a bare <see cref="InspectorIconButton"/> carries no size of its own.</summary>
        public const string ActionButtonUssClassName = UssClassName + "__action";
    ...
    public sealed class InspectorListHeader : InspectorFoldoutHeader
    {
        ...
        /// <summary>Modifier for a header that carries controls of its own beside the add action; its actions take the width its label leaves.</summary>
        public const string HostsControlUssClassName = "lightside-list__header--hosts-control";
