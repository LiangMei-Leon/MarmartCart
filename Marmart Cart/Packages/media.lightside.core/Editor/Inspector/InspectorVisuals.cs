...
namespace LightSide
{
    ...
    public static class InspectorVisuals
    {
        ...
        /// <summary>Sets the title the inspector tooltip falls back to for an element when no visible label names it; blank clears it.</summary>
        public static void SetTooltipTitle(VisualElement element, string value)
        {
