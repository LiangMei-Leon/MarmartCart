...
// SYNC: 2048.0 mirrors GlyphAtlas.PageSize; the global's name mirrors
// LightSideShaderIds.GlyphColorMaxLodName — an unset global reads 0 and pins every fetch to mip 0.
