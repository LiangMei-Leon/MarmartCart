...
struct LightSideSurfaceVertex
{
    ...
    float4 texcoord1 : TEXCOORD1; // x = aspect (glyphW/glyphH) + 1024*(deformRow+1) (see LightSideDeform.hlsl), y = faceDilate, z = cluster index, w = intra-glyph X fraction (0..1) + 2*glyphMode (0 SDF / 1 MSDF / 2 color)
