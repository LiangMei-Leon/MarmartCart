namespace LightSide
{
    ...
    public static class LightSidePaintKind
    {
        ...
        /// <summary>Ramp driven by a repeating outline; the parameter is the element's antialiased coverage, and the surface supplies the pattern through <c>LIGHTSIDE_PAINT_PATTERN</c>.</summary>
        public const float Pattern = 7f;
